 ...
 */
public class SpreadMomentTask extends AsyncTask<Void, Void, ResponseStatus> {
    private long queueItemId;
    private AsyncTaskListener<ResponseStatus> listener;

    public SpreadMomentTask(long queueItemId, AsyncTaskListener<ResponseStatus> listener) {
    ...
    protected ResponseStatus doInBackground(Void... params) {
        final String url = Util.getServerHost() + "/api/moments/share";
